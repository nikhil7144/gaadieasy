...
export const modelSchema = z.object({
  ...
  noOfWheels: z.coerce.number().int().positive().optional(),
...
export const variantSchema = z.object({
  ...
  maxPowerPs: z.coerce.number().positive().optional(),
  payloadCapacityKg: z.coerce.number().int().positive().optional(),
...
export const vehicleStorySchema = z.object({
  ...
  storyType: z.enum(["vehicle_story", "brand_update"]).default("vehicle_story"),
  title: z.string().min(3),
