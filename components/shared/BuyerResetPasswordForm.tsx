...
export function BuyerResetPasswordForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <label className="mt-6 block text-sm font-bold text-slate-700" htmlFor="buyer-new-password">
        New password
      </label>
      <input
      ...
      <label className="mt-4 block text-sm font-bold text-slate-700" htmlFor="buyer-confirm-password">
        Confirm password
      </label>
      <input
        className="mt-2 min-h-12 w-full rounded-lg border border-slate-200 px-3 text-base font-bold text-slate-950 outline-none"
